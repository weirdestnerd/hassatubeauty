...
const offers = [
  {
    name: "Customization like never before",
    description: "You'll customize your wig to your taste",
    href: "#",
  },
  {
    name: "One on one consultation",
    description: "You'll get 1-1 consultation with me",
    href: "#",
  },
  {
    name: "Nationwide shipping",
    description: "We'll ship your wig to you anywhere in US",
    href: "#",
  },
];
                ...
                <div className="max-w-2xl mx-auto py-24 lg:py-64 lg:max-w-none">
                  <div className="lg:pr-16 space-y-4">
                    ...
                    <p className="mt-4 text-xl text-gray-600">
                      We&apos;re getting all the bells and whistles together.
                      Our physical studio is nicely coming together as well.
                    </p>
                    <p className="mt-4 text-xl text-gray-600">
                      Once our awesomeness is ready for you, we&apos;ll email
                      you.
                    </p>
