  ...
  return (
    <header className="relative bg-white">
      ...
      <Transition.Root show={mobileNavOpen} as={Fragment}>
        <Dialog as="div" className="relative z-40" onClose={setMobileNavOpen}>
          <Transition.Child
            as={Fragment}
      ...
      <nav
        ...
        style={{ backgroundColor: "#343235" }}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="h-64 flex items-center">
            <button
              type="button"
              className="basis-12 bg-white p-2 rounded-md text-gray-400"
            ...
            <div className="basis-12 ml-auto flex items-center">
              {/* <LoginNav /> */}
